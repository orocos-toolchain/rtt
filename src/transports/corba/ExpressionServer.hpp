...
{namespace corba
{
    ...
    public:
         ...
         * each new lookup will resolve to the new internal::DataSource instead of the old.
         * The old internal::DataSource becomes 'unserved' and may thus become available for clean-up.
         */
        static void copy( std::map<const base::DataSourceBase*, base::DataSourceBase*>& alreadyCloned );
    };
