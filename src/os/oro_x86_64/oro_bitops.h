/***************************************************************************
  tag: Peter Soetens  Mon Jan 10 15:59:15 CET 2005  oro_bitops.h 

                        oro_bitops.h -  description
                           -------------------
...
/**
 * Adapted by ps to work around RedHat specific warnings in the
 ...
 * containing a bit.
 */
static __inline__ int find_first_zero_bit(const unsigned long * addr, unsigned long size)
{
	int d0, d1, d2;
	int res;
