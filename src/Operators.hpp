...
namespace RTT { namespace detail
{
  ...
  public:
     ...
     */
    virtual DataSourceBase* build(
        const std::string& op, DataSourceBase* a, DataSourceBase* b, DataSourceBase* c ) = 0;
  };
  ...
  public:
    ...
    DataSourceBase* applyTernary( const std::string& op, DataSourceBase* a, DataSourceBase* b,  DataSourceBase* c );
  };
}
