/***************************************************************************
  tag: Peter Soetens  Thu Oct 10 16:17:00 CEST 2002  TestCaseSimple.hpp 

                        TestCaseSimple.hpp -  description
                           -------------------
...
namespace UnitTesting
{
                ...
                public TestCase
    {
        ...
        public:
            /**
             * Constructs a TestCaseSimple object.
             * @param suite  The test suite this test case is a part of.
             */
            TestCaseSimple( TestSuite* suite, WriteInterface* output );
