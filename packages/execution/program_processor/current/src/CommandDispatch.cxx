...
namespace ORO_Execution
{
    ...
    CommandDispatch::CommandDispatch(CommandProcessor* p, CommandInterface* c,  AssignableDataSource<bool>* result )
        : _result(result), send(true), maccepted(false), proc(p), com(c) {}
    ...
    bool CommandDispatch::sent() {
        return !send;
    }

    bool CommandDispatch::accepted() {
        return maccepted;
    }

    bool CommandDispatch::result() {
        return _result->get();
    }
