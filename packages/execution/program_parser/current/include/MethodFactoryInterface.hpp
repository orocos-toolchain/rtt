/***************************************************************************
  tag: Peter Soetens  Mon Jan 19 14:11:26 CET 2004  MethodFactoryInterface.hpp 

                        MethodFactoryInterface.hpp -  description
                           -------------------
...
{
    typedef std::pair<MethodInterface*, ConditionInterface*> ComCon;

    /**
     * @brief An interface for creating MethodInterface instances.
     *
     ...
     * of this in TemplateMethodFactory.hpp, you are encouraged to
     ...
     */
    class MethodFactoryInterface
    {
        public:
            virtual ~MethodFactoryInterface();

            /**
             * @brief Return whether the method com is available..
             * throws nothing.
             */
            virtual bool hasMethod(const std::string& com) const = 0;

            /**
             * @brief Return a list of all available methods.
             * throws nothing.
             */
            virtual std::vector<std::string> getMethodList() const = 0;

            /**
             * @brief Return the description of a given method.
             * @param com The method to get the description from.
             */
             ...
             * construct a method with it via the create method
             * below.
             *
        ...
        virtual std::vector< ArgumentDescription > getArgumentList( const std::string& method ) const = 0;
            ...
            /**
             * @brief Create a Method passing DataSources as the arguments.
             *
             * In this case, the method factory should *not* read out
             * the DataSource's, but it should return a Method and a
             ...
             * TemplateMethodFactory or its helper classes to do
