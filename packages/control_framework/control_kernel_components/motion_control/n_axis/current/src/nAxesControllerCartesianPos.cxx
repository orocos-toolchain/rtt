...
namespace ORO_ControlKernel
{
  ...
  bool nAxesControllerCartesianPos::componentLoaded()
  {
    ...
    if ( !nAxesControllerCartesianPos_typedef::Output::dObj()->Get("Twist", _velocity_out_DOI) ){
  ...
  bool nAxesControllerCartesianPos::componentStartup()
  {
    ...
    if ( !nAxesControllerCartesianPos_typedef::Input::dObj(   )->Get("Frame", _position_meas_DOI) ||
	 !nAxesControllerCartesianPos_typedef::SetPoint::dObj()->Get("Frame", _position_desi_DOI) ){
