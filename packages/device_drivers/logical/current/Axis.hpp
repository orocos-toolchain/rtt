...
#include <fdi/EncoderIncrementalInterface.hpp>
...
namespace CBDeviceDriver
{
    ...
    class Axis
    {
        ...
        public:
             ...
             */
            Axis( ActuatorInterface<double>* a,  EncoderIncrementalInterface* e, SwitchHomingInterface* s ) 
                : homeTask(this), calTask(this), act( a ), encincr( e ), swt( s )
            {
                act->stop();
                int homingPos;
                encincr->readCounter(homingPos);
                cout <<"Axis created, position is "<<homingPos<<endl;
            }
            ...
            /**
             * Homes the axis
             * @post The effector is stopped and positioned at the homing switch
             * @post The encoder position reads zero
             */
            void home();

            /**
             * Callibrates the axis. This tries to compensate for drift of the
             * actuator.
             * @post The actuator receives an offset for motion compensation
             * @post The actuator is stopped
             */
            void callibrate();
             ...
             */
            ActuatorInterface<double>* actuatorGet();
            /**
             * Returns the encoder used
             */
            EncoderIncrementalInterface* encoderGet();
            /**
             * Returns the homing switch used
             */
            SwitchHomingInterface* switchGet();

        private:
            /**
             * Our actuator (motor)
             */
            ActuatorInterface<double>* act;
            /**
             * Our encoder
             */
            EncoderIncrementalInterface* encincr;
            /**
             * Our homing switch
             */
            SwitchHomingInterface* swt;
