...
./ecospkggen.py -V $VERSION -T control-kernel
./ecospkggen.py -V $VERSION -T kernel-components
...
scp orocos-$VERSION.tar.gz srv04:pub_html/orocos/packages/$VERSION || exit 1
cd ..
