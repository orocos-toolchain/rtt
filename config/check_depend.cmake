...
IF ( XERCES )
  ...
  SET(RTT_LINKFLAGS "${RTT_LINKFLAGS} -l${XERCES}")
  SET(XERCES_LIB "xerces-c" CACHE INTERNAL "" FORCE)
ELSE ( XERCES )
...
IF(OROCOS_TARGET STREQUAL "lxrt")
  ...
  IF(EXISTS ${RTAI_INSTALL_DIR}/include/rtai_lxrt.h)
    ...
    SET(LXRT_LINK_DIR "${RTAI_INSTALL_DIR}/lib/" CACHE INTERNAL "" FORCE)
    SET(LXRT_LIB "lxrt" CACHE INTERNAL "" FORCE)
