   ...
   FOREACH (_current_FILE ${ARGN})
	 ...
	 # the ADD_CUSTOM_COMMAND is plainly ignored and left out of the make files.
         ADD_CUSTOM_COMMAND(OUTPUT ${_tserver} ${_server} ${_client} ${_tserverh} ${_serverh} ${_clienth}
          COMMAND ${TAO_IDL_EXECUTABLE} -Wb,export_macro=RTT_API -Wb,export_include=rtt/corba/rtt-corba-config.h ${_current_FILE} -o ${CMAKE_CURRENT_BINARY_DIR} -I${CMAKE_CURRENT_SOURCE_DIR} -I${ORBSVCS_DIR} -DCORBA_IS_TAO
          DEPENDS ${_tmp_FILE}
         )
