...
public:
    ...
    void runState(const std::string& name, TaskContext*, bool trace=true, bool test=true );
...
void StateTest::runState(const std::string& name, TaskContext* tc, bool trace, bool test )
{
