...
if(OROCOS-RTT_FOUND)
  ...
  macro( orocos_component COMPONENT_NAME )
    ...
    SET_TARGET_PROPERTIES( ${COMPONENT_NAME} PROPERTIES
      ...
      LIBRARY_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR}${OROCOS_SUFFIX}/${PROJECT_NAME}
  ...
  macro( orocos_typekit LIB_TARGET_NAME )
    ...
    SET_TARGET_PROPERTIES( ${LIB_TARGET_NAME} PROPERTIES
      OUTPUT_NAME ${LIB_NAME}
      LIBRARY_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR}${OROCOS_SUFFIX}/${PROJECT_NAME}/types
      ${LIB_COMPONENT_VERSION}
      INSTALL_RPATH_USE_LINK_PATH 1
  ...
  macro( orocos_plugin LIB_TARGET_NAME )
    ...
    SET_TARGET_PROPERTIES( ${LIB_TARGET_NAME} PROPERTIES
      OUTPUT_NAME ${LIB_NAME}
      LIBRARY_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR}${OROCOS_SUFFIX}/${PROJECT_NAME}/plugins
      ${LIB_COMPONENT_VERSION}
      INSTALL_RPATH_USE_LINK_PATH 1
