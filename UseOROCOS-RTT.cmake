...
if(OROCOS-RTT_FOUND AND NOT USE_OROCOS_RTT)
  ...
  macro( orocos_component COMPONENT_NAME )
    ...
    # Set library name:
    if ( ${OROCOS_TARGET} STREQUAL "gnulinux" OR ${OROCOS_TARGET} STREQUAL "lxrt" OR ${OROCOS_TARGET} STREQUAL "xenomai" OR ${OROCOS_TARGET} STREQUAL "xenomai3" OR ${OROCOS_TARGET} STREQUAL "win32" OR ${OROCOS_TARGET} STREQUAL "macosx")
