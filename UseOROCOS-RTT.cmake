...
if(OROCOS-RTT_FOUND AND NOT USE_OROCOS_RTT)
  ...
  macro( orocos_component COMPONENT_NAME )
    ...
    SET_TARGET_PROPERTIES( ${COMPONENT_NAME} PROPERTIES
      ...
      INSTALL_RPATH "${USE_OROCOS_LIBRARY_DIRS_WITHOUT_DESTDIR};${OROCOS-RTT_LIBRARY_DIRS};${CMAKE_INSTALL_PREFIX}/lib/orocos${OROCOS_SUFFIX}/${PROJECT_NAME};${CMAKE_INSTALL_PREFIX}/lib;${CMAKE_INSTALL_PREFIX}/${AC_INSTALL_DIR}"
      )
    if(APPLE)
      if (CMAKE_VERSION VERSION_LESS "3.0.0")
        ...
        # cope with CMake 3.x
        SET_TARGET_PROPERTIES( ${COMPONENT_NAME} PROPERTIES
          INSTALL_RPATH "${CMAKE_INSTALL_PREFIX}/lib/orocos${OROCOS_SUFFIX};${CMAKE_INSTALL_PREFIX}/${AC_INSTALL_DIR}"
...
macro( orocos_library LIB_TARGET_NAME )
  ...
  if ( ${OROCOS_TARGET} STREQUAL "gnulinux" OR ${OROCOS_TARGET} STREQUAL "lxrt" OR ${OROCOS_TARGET} STREQUAL "xenomai" OR ${OROCOS_TARGET} STREQUAL "win32" OR ${OROCOS_TARGET} STREQUAL "macosx")
    ...
    SET_TARGET_PROPERTIES( ${LIB_TARGET_NAME} PROPERTIES
      ...
      ${LIB_COMPONENT_VERSION}
      INSTALL_RPATH "${USE_OROCOS_LIBRARY_DIRS_WITHOUT_DESTDIR};${OROCOS-RTT_LIBRARY_DIRS};${CMAKE_INSTALL_PREFIX}/lib;${CMAKE_INSTALL_PREFIX}/${AC_INSTALL_DIR}"
      )
    if(APPLE)
      if (CMAKE_VERSION VERSION_LESS "3.0.0")
        SET_TARGET_PROPERTIES( ${LIB_TARGET_NAME} PROPERTIES
        ...
        # cope with CMake 3.x
        SET_TARGET_PROPERTIES( ${LIB_TARGET_NAME} PROPERTIES
          INSTALL_RPATH "${CMAKE_INSTALL_PREFIX}/${AC_INSTALL_DIR}"
          BUILD_WITH_INSTALL_RPATH TRUE
          INSTALL_RPATH_USE_LINK_PATH TRUE
          MACOSX_RPATH ON)
      endif()
  ...
  macro( orocos_executable EXE_TARGET_NAME )
    ...
    SET_TARGET_PROPERTIES( ${EXE_TARGET_NAME} PROPERTIES
      ...
      INSTALL_RPATH "${USE_OROCOS_LIBRARY_DIRS_WITHOUT_DESTDIR};${OROCOS-RTT_LIBRARY_DIRS};${CMAKE_INSTALL_PREFIX}/bin;${CMAKE_INSTALL_PREFIX}/${AC_INSTALL_DIR}"
      )
    if(APPLE)
      if (CMAKE_VERSION VERSION_LESS "3.0.0")
        SET_TARGET_PROPERTIES( ${EXE_TARGET_NAME} PROPERTIES
        ...
        # cope with CMake 3.x
        SET_TARGET_PROPERTIES( ${EXE_TARGET_NAME} PROPERTIES
          INSTALL_RPATH "@executable_path/../bin;${CMAKE_INSTALL_PREFIX}/${AC_INSTALL_DIR}"
          BUILD_WITH_INSTALL_RPATH TRUE
          INSTALL_RPATH_USE_LINK_PATH TRUE
          MACOSX_RPATH ON)
      endif()
  ...
  macro( orocos_typekit LIB_TARGET_NAME )
    ...
    SET_TARGET_PROPERTIES( ${LIB_TARGET_NAME} PROPERTIES
      ...
      ${LIB_COMPONENT_VERSION}
      INSTALL_RPATH "${USE_OROCOS_LIBRARY_DIRS_WITHOUT_DESTDIR};${OROCOS-RTT_LIBRARY_DIRS};${CMAKE_INSTALL_PREFIX}/lib;${CMAKE_INSTALL_PREFIX}/lib/orocos${OROCOS_SUFFIX}/${PROJECT_NAME}/types;${CMAKE_INSTALL_PREFIX}/${AC_INSTALL_DIR}"
      )
    if(APPLE)
      if (CMAKE_VERSION VERSION_LESS "3.0.0")
        SET_TARGET_PROPERTIES( ${LIB_TARGET_NAME} PROPERTIES
        ...
        # cope with CMake 3.x
        SET_TARGET_PROPERTIES( ${LIB_TARGET_NAME} PROPERTIES
          INSTALL_RPATH "${CMAKE_INSTALL_PREFIX}/lib/orocos${OROCOS_SUFFIX}/types;${CMAKE_INSTALL_PREFIX}/${AC_INSTALL_DIR}"
          BUILD_WITH_INSTALL_RPATH TRUE
          INSTALL_RPATH_USE_LINK_PATH TRUE
          MACOSX_RPATH ON)
      endif()
  ...
  macro( orocos_plugin LIB_TARGET_NAME )
    ...
    SET_TARGET_PROPERTIES( ${LIB_TARGET_NAME} PROPERTIES
      ...
      ${LIB_COMPONENT_VERSION}
      INSTALL_RPATH "${USE_OROCOS_LIBRARY_DIRS_WITHOUT_DESTDIR};${OROCOS-RTT_LIBRARY_DIRS};${CMAKE_INSTALL_PREFIX}/lib;${CMAKE_INSTALL_PREFIX}/lib/orocos${OROCOS_SUFFIX}/${PROJECT_NAME}/plugins;${CMAKE_INSTALL_PREFIX}/${AC_INSTALL_DIR}"
      )
    if(APPLE)
      if (CMAKE_VERSION VERSION_LESS "3.0.0")
        SET_TARGET_PROPERTIES( ${LIB_TARGET_NAME} PROPERTIES
        ...
        # cope with CMake 3.x
        SET_TARGET_PROPERTIES( ${LIB_TARGET_NAME} PROPERTIES
          INSTALL_RPATH "${CMAKE_INSTALL_PREFIX}/lib/orocos${OROCOS_SUFFIX}/plugins;${CMAKE_INSTALL_PREFIX}/${AC_INSTALL_DIR}"
          BUILD_WITH_INSTALL_RPATH TRUE
          INSTALL_RPATH_USE_LINK_PATH TRUE
          MACOSX_RPATH ON)
      endif()
