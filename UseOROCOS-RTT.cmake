...
function( orocos_use_package PACKAGE )
  ...
  if (${PACKAGE}_COMP_FOUND)
    ...
    foreach(COMP_LIB ${${PACKAGE}_COMP_LIBRARIES})
        find_library(${PACKAGE}_COMP_${COMP_LIB}_LIBRARY NAMES ${COMP_LIB} HINTS ${${PACKAGE}_COMP_LIBRARY_DIRS})
        if(${PACKAGE}_COMP_${COMP_LIB}_LIBRARY)
            link_libraries( ${${PACKAGE}_COMP_${COMP_LIB}_LIBRARY} )
            message("Linking with ${PACKAGE}: ${${PACKAGE}_COMP_${COMP_LIB}_LIBRARY}")
        else(${PACKAGE}_COMP_${COMP_LIB}_LIBRARY)
        ...
        endif(${PACKAGE}_COMP_${COMP_LIB}_LIBRARY)
  ...
  if (ROS_ROOT)
    ...
    message("No Ros environment, can't lookup the dependencies of this package.")
  endif (ROS_ROOT)
