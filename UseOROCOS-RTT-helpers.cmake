  ...
  if ( "${PACKAGE}" STREQUAL "rtt")
    ...
    if (${PACKAGE}_COMP_${OROCOS_TARGET}_FOUND)
      ...
      if(DEFINED ENV{DESTDIR})
        ...
        set(${PACKAGE}_COMP_${OROCOS_TARGET}_LIBRARY_DIRS_WITHOUT_DESTDIR ${${PACKAGE}_COMP_${OROCOS_TARGET}_LIBRARY_DIRS})
  ...
  if(NOT ${PACKAGE}_${OROCOS_TARGET}_USED)
    ...
    if(ORO_${PACKAGE}_FOUND OR (${PACKAGE}_FOUND AND NOT ORO_USE_OROCOS_ONLY))
      ...
      if(NOT DEFINED ENV{DESTDIR})
        list(APPEND USE_OROCOS_INCLUDE_DIRS_WITHOUT_DESTDIR ${${PACKAGE}_INCLUDE_DIRS})
        list(APPEND USE_OROCOS_LIBRARY_DIRS_WITHOUT_DESTDIR ${${PACKAGE}_LIBRARY_DIRS})
      else()
        list(APPEND USE_OROCOS_INCLUDE_DIRS_WITHOUT_DESTDIR ${${PACKAGE}_INCLUDE_DIRS})
